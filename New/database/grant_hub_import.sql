...
-- IMPORTANT: Use phpMyAdmin's IMPORT feature (not paste in SQL tab)
-- Or if pasting directly, first create the database manually: CREATE DATABASE grant_hub;

-- If database doesn't exist, create it first:
-- CREATE DATABASE IF NOT EXISTS `grant_hub` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
-- USE `grant_hub`;
...
ON DUPLICATE KEY UPDATE `requirement_code`=`requirement_code`;
...
CREATE TABLE IF NOT EXISTS `dost_application_details` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `application_id` INT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dost_application_sites` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `application_id` INT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dost_personnel_requirements` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `application_id` INT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dost_budget_allocations` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `application_id` INT UNSIGNED NOT NULL,
