...
if (is_post()) {
    ...
    if (!$errors) {
        try {
            ...
            $query = 'UPDATE users SET full_name = :full_name, company_name = :company_name, email = :email';
            ...
            $errors[] = 'Unable to update profile. The email might already exist.';
        }
    }
}
...
<head>
    ...
    <title>Profile - Founder | <?php echo sanitize(app_name()); ?></title>
    ...
    <div class="main-container">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="profile.php" class="menu-link active">👤 Profile</a></li>
            ...
            <div class="card">
                <form method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="company_name" value="<?php echo sanitize($user['company_name'] ?? ''); ?>" required>
                    </div>
                    <div class="form-group">
